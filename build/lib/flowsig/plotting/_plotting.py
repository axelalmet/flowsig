...
def plot_intercellular_flows_from_inflows(adata: sc.AnnData,
        ...
        all_gems = [node for node in adata.uns[flowsig_network_key]['flow_var_types']\
                           if adata.uns[flowsig_network_key]['flow_var_types'][node] == 'module']
        all_outflow_vars = [node for node in adata.uns[flowsig_network_key]['flow_var_types']\
                           if adata.uns[flowsig_network_key]['flow_var_types'][node] == 'outflow']
...
def plot_intercellular_flows_from_gems(adata: sc.AnnData,
        ...
        all_inflow_vars = [node for node in adata.uns[flowsig_network_key]['flow_var_types']\
                           if adata.uns[flowsig_network_key]['flow_var_types'][node] == 'inflow']
        all_outflow_vars = [node for node in adata.uns[flowsig_network_key]['flow_var_types']\
                           if adata.uns[flowsig_network_key]['flow_var_types'][node] == 'outflow']
